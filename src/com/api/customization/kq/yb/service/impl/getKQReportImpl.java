 ...
 * 考勤数组自定义开发逻辑处理重写
 */
@WeaIocReplaceComponent("KQReportImplService") //如不标注名称，则按类的全路径注入
public class getKQReportImpl {
    ...
    @WeaReplaceAfter(value = "/api/kq/report/getKQReport",order = 1,description = "考勤报表增加夜班数据")
